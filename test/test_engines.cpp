...
TEST_CASE_TEMPLATE("test_engines,n=4", T, pcg32, std::mt19937, std::minstd_rand,
                   std::ranlux48) {
  size_t const n_vertices = 4;
  size_t const seed = n_vertices;
  size_t const n_trials = 10000000;
  rmat_generator<T> mygen(n_vertices, seed);
...
TEST_CASE_TEMPLATE("test_engines,n=8", T, pcg32, std::mt19937, std::minstd_rand,
                   std::ranlux48) {
